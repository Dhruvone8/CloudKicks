    ...
    <div className="relative inline-flex font-sans">
      ...
      >
        <Button
          ...
          variant="default"
          className={cn(
            "relative rounded-full h-12 px-8 min-w-[160px] cursor-pointer text-base font-medium transition-colors duration-300 disabled:opacity-100",
            // FIX: Force background to stay primary on hover when idle (removes default dimming)
